    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          //       creationParams: <String, dynamic>{"text": "hello"},
          //       // 用来编码 creationParams 的形式，可选 [StandardMessageCodec], [JSONMessageCodec], [StringCodec], or [BinaryCodec]// 如果存在 creationParams，则该值不能为null
